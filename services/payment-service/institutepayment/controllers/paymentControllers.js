  ...
  try {
    ...
    logActivity({
      ...
      actorRole: user?.role
        ...
        : "",
      action: "Payment Institute",
      description: `${user?.role
        ? user.role.charAt(0).toUpperCase() + user.role.slice(1)
        : "User"} Payment Institute Created successfully`,
    });
...
export const updateInstitutePayment = async (req, res) => {
  try {
    ...
    logActivity({
      ...
      description: `${user?.role
        ? user.role.charAt(0).toUpperCase() + user.role.slice(1)
        : "User"} Payment Institute Updated successfully`,
    });
...
export const deleteInstitutePayment = async (req, res) => {
  try {
    ...
    logActivity({
      ...
      description: `${user?.role
        ? user.role.charAt(0).toUpperCase() + user.role.slice(1)
        : "User"} Payment Institute deleted successfully`,
    });
